...
| :--- | :--- | :--- | :--- |
| **교통사고 데이터** | 사고 위치, 시간, 가해자 연령, 법규 위반 등 | 공공데이터포털 (도로교통공단) | **수도권 (서울, 인천, 경기)** |
...
| **차량 등록 데이터** | (선택) 지역별 렌터카 등록 현황 | 공공데이터포털 | **수도권** |
...
- **예시1 프롬프**: **수도권(서울, 인천, 경기) 시/군/구별** 인구 10만 명당 교통사고 발생 건수를 시각화 한 예시를 **수도권 지도**에 그려줘
  
